...
public class EmpleadoControllerTestRestTemplateTest {
    ...
    public void testGuardarEmpleado(){
        ...
        assertEquals("Diego", empleadoCreado.getNombre());
        assertEquals("Santos", empleadoCreado.getApellido());
        assertEquals("cris.perez@gmail.com", empleadoCreado.getEmail());
    }
    ...
    public void testListarEmpleados(){
        ...
        List<Empleado> empleadoList = Arrays.asList(respuesta.getBody());

        assertEquals(HttpStatus.OK, respuesta.getStatusCode());
        assertEquals(MediaType.APPLICATION_JSON, respuesta.getHeaders().getContentType());

        assertEquals(1, empleadoList.size());
        assertEquals(1L, empleadoList.get(0).getId());
        assertEquals("Diego", empleadoList.get(0).getNombre());
        assertEquals("Santos", empleadoList.get(0).getApellido());
        assertEquals("cris.perez@gmail.com", empleadoList.get(0).getEmail());
    }
    ...
    public void testObtenerEmpleado(){
        ...
        assertEquals("Diego", empleado.getNombre());
        assertEquals("Santos", empleado.getApellido());
        assertEquals("cris.perez@gmail.com", empleado.getEmail());
    }
